          ...
          <div className="row position-relative">
            <div className="col-sm-2 part1 d-flex align-items-center">
              <Button className="bg-g text-white catTab res-hide">
                <GridViewIcon /> &nbsp;Browse All Products <KeyboardArrowDownIcon />
              </Button>
            </div>
              ...
              <nav className={isOpenNav ? "open" : ""}>
                <ul className="list list-inline mb-0">
                      ...
                      <Button onClick={() => openDropdownFun(index)}>
                        ...
                        >
                          {item.cat_name} <KeyboardArrowDownIcon
                            className={`${openDropdownMenu && openDropdownMenuIndex === index && "rotateIcon"}`}
                          />
                        </Link>
                      </Button>
                      {item.items.length !== 0 && (
                  ...
                  <li className="list-inline-item position-static">
                    ...
                    <div
                      className={`dropdown_menu megaMenu w-100 ${openMegaMenu && "open"}`}
                    >
                      <div className="row">
                ...
                {window.innerWidth < 992 && !context.isLogin && (
