            ...
            <section className='newsLetterSection'>
                <div className='container-fluid'>
                    <div className='box d-flex align-items-center'>
                        ...
                        <div className='img'>
                            <img src={NewsletterImg} alt='newsletter' className='w-100' />
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-3 part3'>
                                ...
                                <div className='d-flex'>
                                    <Link to={''}><img src={appStore} alt='appstore' width={150} /></Link>
                                    <Link to={''}><img src={googlePlay} alt='googleplay' className='mx-2' width={150} /></Link>
                                </div>
